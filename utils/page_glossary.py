...
def page_glossary():
    ...
    In the dropdown menu below, you can download the glossary with all terms. 

    If you want to look look up specific terms, choose the terms you want by pressing "Choose an option". You can choose as many as you want. 
